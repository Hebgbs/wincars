...
SET car_cc=bananashplit
SET bdy_cc=banana.prm
SET hul_cc=hull.hul
SET tex_cc=banana.bmp
SET txs_cc=shadow.bmp
REM | Car wheels
SET wfd_cc=wheell.prm
...
MKLINK /H %des_cc%\wincar4\%txs_cc% %des_cc%\%car_cc%\%txs_cc%
